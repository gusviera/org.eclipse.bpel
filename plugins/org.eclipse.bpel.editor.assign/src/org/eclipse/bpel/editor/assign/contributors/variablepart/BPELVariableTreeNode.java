...
public class BPELVariableTreeNode extends TreeNode {
	...
	public BPELVariableTreeNode(Variable variable, boolean isCondensed, boolean displayParticles) {
		super(variable, isCondensed);
		this.displayParticles = displayParticles;

		if (isCondensed) {
			if (variable.getMessageType() != null)  {
				fNode = new MessageTypeTreeNode(variable.getMessageType(), isCondensed);
	...
	public Object[] getChildren() {
		...
		if (variable.getMessageType() != null) {
			return new Object[] {
					new MessageTypeTreeNode(variable.getMessageType(), isCondensed, displayParticles) 
				};			
		}
